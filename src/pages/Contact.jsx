...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: <Mail className="w-5 h-5" />, label: 'Email', value: 'yk1577711@gmail.com', link: 'mailto:yk1577711@gmail.com' },
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: '+91 99717 58962', link: 'tel:+919971758962' },
    { icon: <MapPin className="w-5 h-5" />, label: 'Location', value: 'Delhi, India' },
